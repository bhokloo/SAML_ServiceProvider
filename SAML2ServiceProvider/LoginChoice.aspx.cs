...
namespace SAML2ServiceProvider
{
    public partial class LoginChoice : System.Web.UI.Page
    {
        ...
        protected void loginLocationRadioButtonList_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            bool idpLogin = loginLocationRadioButtonList.SelectedValue == LoginLocations.IdentityProvider; //idp
        ...
        private XmlElement CreateAuthnRequest()
        {
            ...
            string issuerURL = CreateAbsoluteURL("~/"); //sp url..identity url for IDP
            string assertionConsumerServiceURL = CreateAssertionConsumerServiceURL(); //SP's assertion URL for IDP.
