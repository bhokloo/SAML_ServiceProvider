...
<body>
    ...
    <div>
		...
		<asp:RadioButtonList ID="spToIdPBindingRadioButtonList" runat="server" OnSelectedIndexChanged="spToIdPBindingRadioButtonList_SelectedIndexChanged">
		...
		<asp:Button ID="continueButton" runat="server" Text="Continue" OnClick="continueButton_Click" style="height: 35px" />
		<p>
