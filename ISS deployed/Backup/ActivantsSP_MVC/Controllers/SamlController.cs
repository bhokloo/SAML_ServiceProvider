    ...
    public class SamlController : Controller
    {
        public ActionResult InitiateSingleSignOn(string relayState = null)
        {
            try
            {
                ...
                //cert.Import("D:/SAML/SERVICE PROVIDER/ISS deployed/Backup/ActivantsSP_MVC/Certificates/sp.pfx", "activants", X509KeyStorageFlags.PersistKeySet | X509KeyStorageFlags.MachineKeySet);
