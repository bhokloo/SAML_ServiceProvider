...
namespace ClientApplication.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public void LogOff()
        {
            ...
            string relayState = HttpUtility.UrlEncode(Cryptography.Encrypt("https://localhost:44313/Home/Index"));
            string errPage = HttpUtility.UrlEncode(Cryptography.Encrypt("https://localhost:44313/Home/errorPage"));
            Response.Redirect(string.Format("https://localhost:44308/saml/InitiateSingleLogout?relayState={0}&errPage={1}", relayState, errPage));
        }
