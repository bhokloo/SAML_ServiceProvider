...
namespace ClientApplication.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public void LogOff()
        {
            ...
            relayStateForSP.Value = Convert.ToBase64String(MachineKey.Protect(Encoding.UTF8.GetBytes("https://localhost:44313/Home/Index")));
            ...
            Response.Redirect("https://localhost:44307/saml/InitiateSingleLogout");
        }
